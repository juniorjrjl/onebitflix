...
User.prototype.checkPassword = function(password: string, callback: CheckPasswordCallback) {
    bcrypt.compare(password, this.password, (err, isSame) => callback(err, err ? false: isSame))
}