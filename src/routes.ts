...
router.get('/episodes/stream', ensureQuery, episodesController.stream)
...
router.put('/users/current', ensure, usersController.update)
router.put('/users/current/password', ensure, usersController.changePassword)
